...
const stageGroups = [
  { id: 'a', label: 'あ行まで', stages: [1] },
  { id: 'ka', label: 'か行まで', stages: [2] },
  { id: 'sa', label: 'さ行まで', stages: [3] },
  { id: 'ta', label: 'た行まで', stages: [4] },
  { id: 'na', label: 'な行まで', stages: [5] },
  { id: 'ha', label: 'は行まで', stages: [6] },
  { id: 'ma', label: 'ま行まで', stages: [7] },
  { id: 'ya', label: 'や行まで', stages: [8] },
  { id: 'ra', label: 'ら行まで', stages: [9] },
  { id: 'wa', label: 'わ行まで', stages: [10] },
  { id: 'dakuon', label: '濁音(")まで', stages: [11] },
  { id: 'handakuon', label: '半濁音(゜)まで', stages: [12] },
  { id: 'sokuon', label: '促音(ちゃ)まで', stages: [13] }
];
